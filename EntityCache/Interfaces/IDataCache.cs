...
namespace EntityCache.Interfaces
{
    public interface IDataCache
    {
        ...
        /// </summary>
        /// <param name="force">
        ///     if true, properties of domain objects will be overwritten by entity properties when there is no
        ///     backing field to handle the pulling/conflict.
        /// </param>
        ...
        ///     the domain object to be pulled from the database (all referenced entities will be pulled as
        ///     well)
        /// </param>
        /// <param name="force">
        ///     if true, properties of domain objects will be overwritten by entity properties when there is no
        ...
        /// <summary>
        ///     Pulls all data from database, resolves conflicts and then pushes the local data to the database (with force =
        ///     false)
        /// </summary>
        ...
        /// <summary>
        ///     Pulls all data (for the given type) from database, resolves conflicts and then pushes the local data (of the given
        ///     type) to the database (with force = false)
        /// </summary>
        /// <param name="resolveConflictsCallback">the callback used to resolve conflicts</param>
        /// <returns></returns>
        bool Synchronize<TCachedEntity>(Action<IEnumerable<PullConflicts>> resolveConflictsCallback)
            where TCachedEntity : ICachedEntity;

        /// <summary>
        ///     Pulls the domain objects from database, resolves conflicts and then pushes the domain object to the database (with
        ///     force = false)
        /// </summary>
